...
public class SmartsParser {
    ...
    void parseSpecialSymbol() {
        ...
        case '*': //Any atom
            ...
            curChar++;
            System.out.println("add atom spec symbol "+curAtom.getSymbol());
            addAtom(curAtom);
            break;
    ...
    void setDoubleStereoBond(SMARTSBond doubleBond, IAtom atom, IAtom at0, SMARTSBond dirBond, int direction,
                             int atomPos) {
		...
		*/
        ...
        isUnspecified =
                (direction == SmartsConst.BT_UPUNSPEC) || (direction == SmartsConst.BT_DOWNUNSPEC) || (direction2 ==
                                                                                                       SmartsConst.BT_UPUNSPEC) ||
    ...
    static public void prepareTargetForSMARTSSearch(boolean neighbourData, boolean valenceData, boolean ringData,
                                                    boolean ringData2, boolean explicitHData,
                                                    boolean parentMoleculeData, IAtomContainer container) {
        if (neighbourData)
